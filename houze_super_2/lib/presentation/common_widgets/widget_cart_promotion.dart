...
import 'package:houze_super/presentation/common_widgets/text_limit_widget.dart';
...
class CardPromotionWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
        onTap: () {
          AppRouter.push(context, AppRouter.VOUCHER_DETAIL_SCREEN,
                          ...
                          child: Row(
                            children: <Widget>[
                              TextLimitWidget(this.couponModel.shops![0].name!,
                                  maxLines: 1, style: AppFont.SEMIBOLD_WHITE_12)
                            ],
                          ),
