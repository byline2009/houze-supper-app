...
import 'package:houze_super/presentation/common_widgets/houze_xu_info/bloc/houze_xu_bloc.dart';
...
typedef CallBackHandler = Function(bool);

class FilterActionType {
  String type;
  String content;
  FilterActionType({required this.type, required this.content});
}

class WidgetHowToGetPoint extends StatefulWidget {
  final bool disabledChangeBuilding;
  final CallBackHandler didChangeBuildingCallback;
  WidgetHowToGetPoint(
      {this.disabledChangeBuilding = false,
      required this.didChangeBuildingCallback});
...
class _WidgetHowToGetPointState extends State<WidgetHowToGetPoint> {
                        ...
                        MultiBlocProvider(
                          providers: <BlocProvider>[
                            ...
                            BlocProvider<TabbarTitleBloc>(
                                create: (_) => tabbarBloc),
                            BlocProvider<HouzeXuBloc>(
                                create: (_) => houzeXuBloc)
                          ],
  ...
  Widget houzeXuItem(
      {required int amount, required String imagePath, required String title}) {
    return Padding(
            ...
            child: Column(
              ...
              children: [
                Text(
                  ...
                  //     .copyWith(letterSpacing: 0.14),
                  style: AppFont.SEMIBOLD_PURPLE_6001d2_13.copyWith(
                      letterSpacing: 0.14),
                ),
                const SizedBox(
                  height: 5.0,
                      ...
                      text: TextSpan(
                        children: <TextSpan>[
                          ...
                          TextSpan(
                            ...
                            style: AppFont.SEMIBOLD_d68100_13.copyWith(
                                fontSize: 15),
                          )
                        ],
                      ),
                  ...
                  child: TextButton(
                    onPressed: () {
                      if (!disabled) {
                        ...
                        widget.didChangeBuildingCallback(true);
                      }
                    },
                    style: ButtonStyle(
