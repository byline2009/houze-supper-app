...
class WidgetPointsLimit extends StatelessWidget {
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                if (pointLimit != null && pointLimit!.length != 0)
                  Container(
  ...
  Widget houzeXuItem(BuildContext context,
      {required PointLimitModel pointLimitItem,
          ...
          Row(
            children: [
              ...
              Text(
                ...
                // style: AppFont.BOLD_BLACK_15.copyWith(letterSpacing: 0.14),
              ),
            ],
          ),
          const SizedBox(
        ...
        Row(
          children: [
            Text(
              ...
              // style: AppFont.SEMIBOLD_d68100_13.copyWith(fontSize: 15),
            ),
            const SizedBox(
              width: 5.0,
            ),
