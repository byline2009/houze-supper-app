...
class BaseWidget {
  ...
  static BoxDecoration dividerBottom({required double height, Color? color}) {
        ...
        ? Padding(
            ...
            child: DecoratedBox(
              ...
              child: Padding(
                ...
                child: Text(text, style: AppFonts.medium14),
              ),
            ),
          )
        : Center();
    ...
    return Row(
      children: <Widget>[
        ...
        Expanded(
          ...
          children: <Widget>[
            Text(apartmentTitle, style: AppFont.BOLD_BLACK_15),
            SizedBox(height: 5),
            Text(
        ...
        Icon(Icons.arrow_forward, color: AppColor.gray_d1d6de, size: 20.0)
      ],
    );
  }
  ...
  static Widget avatar({
    ...
    return Container(
      ...
      child: (imageUrl ?? "").isEmpty && fullname.isEmpty
          ? Center(
              child: Icon(
                  ...
                  child: (imageUrl ?? "").isNotEmpty
                      ...
                      : Center(
                          child: Text(
                            ...
                            style: AppFont.BOLD_WHITE.copyWith(
                              fontSize: ratio,
                            ),
                          ),
                        ),
        ...
        children: <Widget>[
          Text(
            ...
            style: AppFonts.regular14.copyWith(
                ...
                .copyWith(color: leadingColor ?? AppColor.gray_808080),
          ),
          Text(
            value,
            textAlign: TextAlign.right,
            style: AppFonts.medium14
                .copyWith(color: traillingColor ?? AppColor.black),
          )
        ],
      ),
    );
  ...
  static Widget containerBodyTopShadow(
    Widget content,
  ) {
    return DecoratedBox(
        decoration: BoxDecoration(
