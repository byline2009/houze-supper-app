...
class PaymentLoadGateway extends PaymentEvent {
  ...
  PaymentLoadGateway({this.buildingId});
}
...
class PaymentLoadHistory extends PaymentEvent {
  ...
  PaymentLoadHistory({this.apartmentId, this.limit, this.status});
  @override
  List<Object> get props => [];
  @override
  String toString() =>
...
class TransactionLoadList extends PaymentEvent {
  ...
  @override
  List<Object> get props =>
      [this.apartmentId ?? '', this.page ?? '', this.status ?? ''];
  @override
  String toString() =>
