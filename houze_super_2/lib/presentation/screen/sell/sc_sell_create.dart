...
class _SellCreatePageState extends RouteAwareState<SellCreatePage> {
  final _apartmentBloc = ApartmentBloc(
    apartmentRepo: ApartmentRepository(),
  );

  final SellTicketModel _sellTicketModel =
      SellTicketModel(images: [], imagesAuthenticated: []);
  ...
  void _checkValidation() {
    if (_controllers.every((e) => e.text.trim().isNotEmpty) &&
        ...
        apartment?.id != null) {
      print("Im workingggggg true");
      setState(() => _hasValidation = true);
    } else {
      print("Im workingggggg false");
          ...
          Container(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                hintStyle: AppFont.MEDIUM_GRAY_808080,
                hintMaxLines: 6,
                border: InputBorder.none,
              ),
