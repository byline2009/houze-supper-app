...
import 'package:houze_super/app/blocs/overlay/overlay_bloc.dart';
...
import 'package:houze_super/presentation/screen/profile/point/bloc/point_bloc.dart';
...
class _HouseXuScreenState extends RouteAwareState<HouseXuScreen> {
  final OverlayBloc overlayBloc = OverlayBloc();
  // ignore: close_sinks
  final PointHistoryBloc pointBloc = PointHistoryBloc();
