    ...
    return Container(
      child: SfCartesianChart(
            ...
            builder: (dynamic data, dynamic point, dynamic series,
              ...
              return Container(
                  ...
                  child: Column(
                      ...
                      children: [
                        Text('Hôm nay', style: AppFont.SEMIBOLD_GRAY_9c9c9c_13),
                        Text(value + ' ' + unit, style: AppFont.BOLD_BLACK_15)
                      ]));
            }),
        ...
        primaryXAxis: CategoryAxis(
            ...
            axisLine: AxisLine(color: AppColor.gray_d0d0d0),
            majorGridLines: MajorGridLines(width: 0),
            labelStyle:
                AppFont.SEMIBOLD_GRAY_9c9c9c_13.copyWith(letterSpacing: 0.26)),
