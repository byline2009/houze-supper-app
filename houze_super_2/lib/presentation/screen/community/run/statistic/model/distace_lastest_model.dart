...
class DistanceDateModel extends Equatable {
  ...
  String averageDistanceKm() => averageDistance != null
      ? (averageDistance ?? 0.0 / 1000.0).toStringAsFixed(1)
      : '';
  String averageHour() => (averageSecond ?? 0.0 / 3600.0).toStringAsFixed(1);
  @override
