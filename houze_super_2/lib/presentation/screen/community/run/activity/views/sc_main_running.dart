...
class _RunMainScreenState extends RouteAwareState<RunMainScreen> {
  late File file;
  ...
  late double totalDistance, lastDistance = 0.0;
  ...
  Widget build(BuildContext context) {
    ...
    final String timeStr = formatTime(mapValue['time'] ?? 0);
