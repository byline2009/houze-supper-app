...
/*Lấy danh sách yêu cầu tham gia nhóm*/
  ...
  Future<bool> putConfirmRequestJoinTeam(
    ...
    try {
      ...
      debugPrint("putConfirmRequestJoinTeam: ${e.response!.data}");
    }
    return false;
  }
  ...
  Future<JoinTeamState> putJoinGroupByCode({required String code}) async {
    try {
      ...
      ResponeJoinGroupCodeError data =
          ResponeJoinGroupCodeError.fromJson(response.data);
  ...
  Future<bool> putGroupRemoveMember(
    ...
    try {
      debugPrint("putGroupRemoveMember: userID: $userID \n groupID: $groupID ");
      ...
      debugPrint("putGroupRemoveMember: response: ${e.response!.data} ");
    }
    return false;
  }
  ...
  void errorLog(String functionName, String content) {
    debugPrint('[*** GroupAPI] $functionName \t $content');
  }
}
