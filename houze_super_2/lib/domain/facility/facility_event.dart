...
class FacilityGetDetailEvent extends FacilityEvent {
  ...
  FacilityGetDetailEvent({required this.id});
  @override
...
class FacilityGetBookingDetailEvent extends FacilityEvent {
  ...
  FacilityGetBookingDetailEvent({required this.id});
  @override
  List<Object> get props => [id];
  @override
...
class FacilityGetHistoryEvent extends FacilityEvent {
  ...
  FacilityGetHistoryEvent({required this.id});
  @override
  List<Object> get props => [id];
  @override
...
class FacilityGetWorking extends FacilityEvent {
  ...
  FacilityGetWorking({required this.id, required this.date});
  @override
