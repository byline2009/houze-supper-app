...
class DesignUtil {
  static const int widthScreenDevice = 375;
  static const int heightScreenDevice = 812;
}
...
class ServiceConverter {
  ...
  static Future<String> convertTypeBuilding(String type) async {
    BuildingMessageModel building = BuildingMessageModel();
    building = await Sqflite.getCurrentBuilding();
    int getType = building.type > 1 ? 0 : building.type;
  ...
  static Future<String> convertTypeService(String type, String service) async {
    return dictionary[type][TypeService[service]];
  }

  static Future<String> getTextToConvert(String type) async {
    final service = ServiceConverter.convertTypeBuilding(type);
    return service;
  }
}
