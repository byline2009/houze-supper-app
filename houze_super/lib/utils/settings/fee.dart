...
class FeeSettings {
  static int feeDefaultTypes = 5;

  static List<FeeModel> feeTypes = [
  ...
  static Map<String, PaymentGatewayModel> paymentGateways = {
    ...
    'payme': PaymentGatewayModel(
      order: 6,
      isCheck: true,
      gatewayIcon: 'me',
      gatewayTitle: 'k_e_wallet_payME',
      gatewayName: 'payme',
      gatewayDesc: 'k_wallet_balance',
    ),
  };
...
//  }
  ...
  static Future<List<FeeMessageModel>> sortFeeV2(String buildingID,
    ...
    BuildingMessageModel building = await Sqflite.getBuildingWithId(buildingID);
