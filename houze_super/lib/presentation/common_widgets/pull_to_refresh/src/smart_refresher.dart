...
import '../../custom_refresh_indicator/src/indicators/apple_refresh_indicator.dart';
...
typedef BodyBuilder = List<Widget> Function(List<Widget> listWidget);
...
class SmartRefresherState extends State<SmartRefresher> {
  ...
  Widget _buildBodyBySlivers(
    ...
    if (childView is! Scrollable) {
      ...
      ScrollPhysics physics = widget.physics ?? const BouncingScrollPhysics();
      ...
      body = CustomRefreshIndicator(
          ...
          child: CustomScrollView(
            ...
            physics: _getScrollPhysics(
                conf, physics ?? AlwaysScrollableScrollPhysics()),
            slivers: slivers,
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.builder != null)
      ...
      List<Widget> slivers = widget.bodyBuilder != null
          ? widget.bodyBuilder(
