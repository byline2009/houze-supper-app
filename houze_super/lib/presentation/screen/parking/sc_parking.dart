...
class ParkingCardListPage extends StatefulWidget {
  const ParkingCardListPage();

  @override
  _ParkingCardListPageState createState() => _ParkingCardListPageState();
}

class _ParkingCardListPageState extends State<ParkingCardListPage> {
        ...
        Positioned(
            ...
            child: FloatingButtonWidget(callback: () {
              AppRouter.pushNoParamsWithCallback(
                  context, AppRouter.parkingRegistration, _onCallBack);
            })),
      ]),
    );
  }
