...
import 'package:houze_super/utils/settings/rating.dart';
...
import 'package:houze_super/presentation/common_widgets/houze_point/widget_receive_points.dart';
...
class RatingServiceScreenState extends State<RatingServiceScreen> {
          ...
          children: <Widget>[
            ListView(
              ...
              children: <Widget>[
                ...
                makeComment(),
                if (_xuEarn != null && _xuEarn.ticketRatingAward != 0)
                  WidgetReceiveXu(xu: _xuEarn.ticketRatingAward),
                makeSendButton()
              ],
            ),
            progressToolkit
              ...
              switch (rating.toInt()) {
                ...
                case 4:
                  setState(() {
                    ...
                    titleRatingStar =
                        LocalizationsUtil.of(context).translate("very_good");
                ...
                case 5:
                  setState(() {
                    ...
                    titleRatingStar =
                        LocalizationsUtil.of(context).translate("excellent");
