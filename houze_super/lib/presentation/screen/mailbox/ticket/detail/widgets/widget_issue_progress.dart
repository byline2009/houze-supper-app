...
class WidgetIssueProgress extends StatelessWidget {
  ...
  Color _getStatusColor(
    ...
    return ticket.status == status ? Color(0xff7A1DFF) : Colors.black;
  }
  ...
  Widget build(BuildContext context) {
    return Column(
      children: <Widget>[
        const WidgetSectionTitle(title: 'progress'),
          ...
          child: Column(
            ...
            children: <Widget>[
              WidgetRow(
                ...
                value: DateUtil.format("dd/MM/yyyy - HH:mm", ticket.assignTime),
                color: _getStatusColor(
                  ticket,
              ...
              WidgetRow(
                ...
                value: DateUtil.format("dd/MM/yyyy - HH:mm", ticket.doingAt),
                color: _getStatusColor(
                  ticket,
                  TicketStatus.inProgress.index,
                ),
              ),
              WidgetRow(
                label: 'completed_with_colon',
                value:
                    DateUtil.format("dd/MM/yyyy - HH:mm", ticket.completedAt),
                color: _getStatusColor(
                  ticket,
