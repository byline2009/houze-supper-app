...
class _SellUpdatePageState extends State<SellUpdatePage> {
  ...
  final _sellTicketModel = SellTicketModel();
  ...
  DropdownButtonHideUnderline _buildDropdown({
    ...
    return DropdownButtonHideUnderline(
      child: DropdownButton<ApartmentMessageModel>(
        value: _value ??= apartments.firstWhere((e) => e.name == apartmentName),
        isExpanded: true,
        isDense: true,
        icon: Icon(Icons.keyboard_arrow_down),
        style: AppFonts.medium14,
        onChanged: (ApartmentMessageModel value) =>
            setState(() => _value = value),
        items: apartments
            .map<DropdownMenuItem<ApartmentMessageModel>>(
              (e) => DropdownMenuItem<ApartmentMessageModel>(
                value: e,
                child: Text(
                  e.name,
          ...
          Flexible(
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                hintStyle: AppFonts.medium14.copyWith(
                  color: Color(0xff838383),
                ),
                                  ...
                                  child: BlocBuilder<ApartmentBloc,
                                    ...
                                    if (apartments.isNotEmpty)
                                      return _buildDropdown(
                                        ...
                                        apartmentName: state.sell.apartmentName,
                                      );
