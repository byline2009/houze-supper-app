...
class _MyVoucherDetailScreenState extends State<MyVoucherDetailScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    double _heightImage = _pageSize.height * 30 / 100;
    return Scaffold(
          ...
          BlocProvider<BaseBloc>(
            ...
            child: BlocBuilder<BaseBloc, BaseState>(
              ...
              if (promotionState is BaseInitial) {
                _promotionBloc.add(BaseLoadList());
              }
                      ...
                      child: FadingStretchy(
                          ...
                          appbarHandler: (double opacity) {
                            return FadingAppbar(
                                ...
                                title: Flexible(
                                  ...
                                  duration: duration,
                                  opacity: opacity,
                                  child: Text(promotionDetail.shops.first.name,
                          ...
                          body: Container(
                              ...
                              child: ListView(
                                  ...
                                  children: <Widget>[
                                    Container(
                                        height: 10, color: Color(0xfff5f5f5)),
                                      ...
                                      callback: () async {
                                        ...
                                        try {
                                          final rs = await _merchantRepository
                                              .createCoupon(promotionDetail.id);
                                          if (rs.id != "") {
  ...
  Widget titlePromotion(CouponModel promotionDetail) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border(
            bottom: BorderSide(
                color: Color(0xfff5f5f5), width: 1, style: BorderStyle.solid)),
      ),
      child: Column(
            ...
            children: <Widget>[
              Text(LocalizationsUtil.of(context).translate('end_at_with_colon'),
                  style: AppFonts.regular15
                      .copyWith(color: Color(0xff808080), wordSpacing: 1.4)),
              Text(
                  DateUtil.format(
