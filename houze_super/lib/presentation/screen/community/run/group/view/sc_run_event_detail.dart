...
class _RunEventDetailScreenState extends State<RunEventDetailScreen> {
  EventModel _eventModel;
  final ProgressHUD progressToolkit = Progress.instanceCreateWithNormal();
  ScrollController _controller;
  StreamSubscription<BlocEvent> _subChallengeUpdateDetailByID;

  double _headerSize = 0.0;
  RunningState _currentRunningState;
  ...
  void initState() {
    ...
    if (_eventModel != null && !StringUtil.isEmpty(_eventModel.id)) {
      _groupBloc.add(
  ...
  void dispose() {
    ...
    if (_subChallengeUpdateDetailByID != null)
