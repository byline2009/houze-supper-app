...
abstract class GroupState extends Equatable {
  GroupState([List props = const []]) : super();
}
...
class CreateNewGroupFailure extends GroupState {
  ...
  CreateNewGroupFailure({@required this.error}) : super([error]);
...
class LoadEventRequestGroupFailure extends GroupState {
  ...
  LoadEventRequestGroupFailure({@required this.error}) : super([error]);
...
class LoadEventGetAllAchievementSuccessful extends GroupState {
  ...
  LoadEventGetAllAchievementSuccessful({@required this.result});
...
class LoadEventGetAllAchievementFailure extends GroupState {
  ...
  LoadEventGetAllAchievementFailure({@required this.error}) : super([error]);
...
class StateLoadEventDetailSuccessful extends GroupState {
  ...
  @override
  String toString() =>
      'StateLoadEventDetailSuccessful { \n event_model:\n ${eventModel.toJson()} \n \n group_model:\n ${groups.length > 0 ? groups[0].toJson() : null}}';
}

class StateLoadEventDetailFailure extends GroupState {
  final String error;

  StateLoadEventDetailFailure({@required this.error}) : super([error]);
