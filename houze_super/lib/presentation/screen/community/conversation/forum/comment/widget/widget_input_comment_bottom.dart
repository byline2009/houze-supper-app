...
class _WidgetInputCommentBottomState extends State<WidgetInputCommentBottom> {
  ...
  Future<dynamic> runTaskUpload(
    ...
    final task = Task(
        function: uploadPollCommentImageWorker,
        arg: ArgUpload(
    ...
    Executor()
      ...
      if (result != null && result.id != "") {
        ...
        if (widget.pollCommentImageCallback != null) {
          widget.pollCommentImageCallback(ImageModel(id: result.id));
        }
      }
                ...
                Positioned(
                  ...
                  child: GestureDetector(
                    onTap: () {
                      setState(() {
                        this._imgFile = null;
                        widget.pollCommentImageCallback(null);
                      });
                    },
                    child: Align(
