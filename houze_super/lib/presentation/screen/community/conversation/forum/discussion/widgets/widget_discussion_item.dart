...
class _WidgetPollItemState extends State<WidgetDiscussionItem> {
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    tagDiscussion(widget.discussionModel.category),
                    Text(
                ...
                if (widget.discussionModel.images.length > 0)
                  _discusionImage(context),
                SizedBox(
                  height: 15.0,
                ),
                _likeAndCommentSection(discussionModel: widget.discussionModel),
                SizedBox(
                  height: 25.0,
                ),
              ],
          ...
          children: [
                ...
                child: Stack(
                  ...
                  children: <Widget>[
                    widget.discussionModel.user.imageThumb == null
                        ...
                        : CachedImageWidget(
                            cacheKey: 'avatarKey',
                            imgUrl: widget.discussionModel.user.imageThumb,
                            width: 40.0,
                            height: 40.0,
                          ),
                  ],
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text(
                    widget.discussionModel.displayType ==
  ...
  Widget _discusionImage(BuildContext context) {
  ...
  void _toggleLike({DiscussionModel discussionModel}) async {
  ...
  _updateCommentCount({int count}) {
    widget.discussionBloc.add(
        UpdateCommentQuantity(id: widget.discussionModel.id, quantity: count));
  }
  ...
  Widget _likeAndCommentSection({DiscussionModel discussionModel}) {
    return Container(
      child: Row(
        children: [
          Row(
          ...
          InkWell(
            ...
            child: Row(
              children: [
                ...
                Text(
                  widget.totalComments != null && widget.totalComments > 0
