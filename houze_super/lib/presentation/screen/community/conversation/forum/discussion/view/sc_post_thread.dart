...
import 'package:houze_super/presentation/screen/community/conversation/forum/discussion/networking/discussion_api.dart';
...
class _PostThreadScreenState extends State<PostThreadScreen> {
  ...
  bool checkValidation() {
    if (!StringUtil.isEmpty(ticketModel.buildingId) &&
                  ...
                  .map(
                    (e) => ChoiceChip(
                      ...
                      labelStyle: chipIndex == category.indexOf(e)
                          ? AppFonts.medium.copyWith(color: Color(0xff7A1DFF))
          ...
          Padding(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                hintStyle: AppFonts.medium18.copyWith(
                  color: Color(0xff9c9c9c),
                ), //MEDIUM_GRAY_9C9C9C_18,
