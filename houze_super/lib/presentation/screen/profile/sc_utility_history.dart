...
class _UtilityHistoryScreenState extends State<UtilityHistoryScreen>
  ...
  void initState() {
    ...
    _tabs = [
      NaviagationTab(title: "facility", screen: _UtilityContent()),
      NaviagationTab(
        title: 'service',
